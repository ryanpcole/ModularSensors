 ...
 *
 * @brief Contains the ysiEXO3 sensor subclass and the variable subclasses
 * 
 * TODO: Figure out what the YSI subclasses are. Maybe
 *  ysiEXO3_EC, ysiEXO3_Temp, ysiEXO3_DO, ysiEXO3_fdom, ysiEXO3_turbidity, ysiEXO3_pH
 * 
...
// Debugging Statement
// #define MS_ysiEXO3_DEBUG

#ifdef MS_METERTEROS12_DEBUG
#define MS_DEBUGGING_STD "ysiEXO3"
#endif
 ...
 *
 * {{ @ref ysiEXO3_Count::ysiEXO3_Count }}
 */
/**@{*/
/**
 ...
 *     - +/-8% from 10-20 dS/m
 *
 * {{ @ref ysiEXO3_ECbulk::ysiEXO3_ECbulk }}
 */
/**@{*/
/**
 ...
 */
/* clang-format on */
class ysiEXO3 : public SDI12Sensors {
 public:
     ...
     * default value of 1.
     */
    ysiEXO3(char SDI12address, int8_t powerPin, int8_t dataPin,
                 uint8_t measurementsToAverage = 1)
        : SDI12Sensors(SDI12address, powerPin, dataPin, measurementsToAverage,
                       "ysiEXO3", TEROS12_NUM_VARIABLES,
     ...
     * @copydoc ysiEXO3::ysiEXO3
     */
    ysiEXO3(int SDI12address, int8_t powerPin, int8_t dataPin,
                 uint8_t measurementsToAverage = 1)
        : SDI12Sensors(SDI12address, powerPin, dataPin, measurementsToAverage,
                       "ysiEXO3", TEROS12_NUM_VARIABLES,
                       TEROS12_WARM_UP_TIME_MS, TEROS12_STABILIZATION_TIME_MS,
 ...
 */
/* clang-format on */
class ysiEXO3_Count : public Variable {
 public:
    /**
     * @brief Construct a new ysiEXO3_Count object.
     *
     * @param parentSense The parent ysiEXO3 providing the result
     * values.
     ...
     */
    explicit ysiEXO3_Count(
        ysiEXO3* parentSense, const char* uuid = "",
     ...
     * @brief Construct a new ysiEXO3_Count object.
     *
     * @note This must be tied with a parent ysiEXO3 before it can be used.
     */
    ysiEXO3_Count()
    ...
    /**
     * @brief Destroy the ysiEXO3_Count object - no action needed.
     */
    ~ysiEXO3_Count() {}
};
 ...
 */
/* clang-format on */
class ysiEXO3_ECbulk : public Variable {
 public:
    /**
     * @brief Construct a new ysiEXO3_Count object.
     *
 ...
 */
/* clang-format on */
class ysiEXO3_Temp : public Variable {
 public:
    /**
     * @brief Construct a new ysiEXO3_Temp object.
     *
     * @param parentSense The parent ysiEXO3 providing the result
     * values.
     * @param uuid A universally unique identifier (UUID or GUID) for the
     ...
     */
    explicit ysiEXO3_Temp(ysiEXO3* parentSense, const char* uuid = "",
    ...
    /**
     * @brief Destroy the ysiEXO3_Temp object - no action needed.
     */
    ~ysiEXO3_Temp() {}
};
 ...
 */
/* clang-format on */
class ysiEXO3_Ea : public Variable {
 public:
    /**
     * @brief Construct a new ysiEXO3_Ea object.
     *
     * @param parentSense The parent ysiEXO3 providing the result
     * values.
     * @param uuid A universally unique identifier (UUID or GUID) for the
     ...
     */
    explicit ysiEXO3_Ea(ysiEXO3* parentSense, const char* uuid = "",
    ...
    /**
     * @brief Destroy the ysiEXO3_Ea object - no action needed.
     */
    ~ysiEXO3_Ea() {}
};
 ...
 */
/* clang-format on */
class ysiEXO3_VWC : public Variable {
 public:
    /**
     * @brief Construct a new ysiEXO3_VWC object.
     *
     * @param parentSense The parent ysiEXO3 providing the result
     * values.
     * @param uuid A universally unique identifier (UUID or GUID) for the
     ...
     */
    explicit ysiEXO3_VWC(ysiEXO3* parentSense, const char* uuid = "",
    ...
    /**
     * @brief Destroy the ysiEXO3_VWC object - no action needed.
     */
    ~ysiEXO3_VWC() {}
};
/**@}*/
