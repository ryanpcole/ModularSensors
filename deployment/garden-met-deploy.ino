/** =========================================================================
 * @file garden-met-deploy.ino
 * @brief First attemt at home garden met station setup
 *
...
Variable* variableList[] = {
    ...
    new SensirionSHT4x_Temp(&sht4x)          // Percent full scale (EnviroDIY_LTEB_SignalPercent)
};
...
const char* UUIDs[] =  // UUID array for device sensors
    {
        ...
        "12345678-abcd-1234-ef00-1234567890ab"   // onboard temp
};
...
void setup() {
    ...
    // Begin the publisher
    Mqtt.begin(dataLogger, &modem.gsmClient, MQTTtopic);
